<?php echo form_open(get_uri("green_crm/save_plan"), ["id"=>"green-plan-form", "class"=>"general-form"]); ?>
...
<?php echo form_close(); ?>
<script>$(document).ready(function(){ $("#green-plan-form").appForm({onSuccess:function(){ if($("#green-plans-table").length){$("#green-plans-table").appTable({reload:true});} }}); });</script>
