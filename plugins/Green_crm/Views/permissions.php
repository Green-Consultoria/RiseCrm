...
$green_perms = [
    ...
    "green_crm_manage_commission_grades" => "Gerenciar grades de comissão (criar/editar/versionar)",
    "green_crm_recalculate_commissions" => "Recalcular comissões de vendas",
